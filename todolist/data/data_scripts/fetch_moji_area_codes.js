...
// 结果路径
const AREA_CODES_FILE_PATH = path.resolve(__dirname, '../weather/moji_weather_area_codes.json');
const PROVINCES_FILE_PATH = path.resolve(__dirname, '../weather/moji_china_provinces.json');
