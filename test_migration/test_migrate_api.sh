...
# 项目目录名
BASE_PROJECT_NAME="todolist-python"  # 基准项目目录名
MIGRATE_PROJECT_NAME="todolist-go"  # 迁移项目目录名

# 项目显示名称
BASE_PROJECT_DISPLAY_NAME="Python"  # 基准项目显示名称
MIGRATE_PROJECT_DISPLAY_NAME="Go"  # 迁移项目显示名称
...
# 默认端口
BASE_PORT=3001  # 基准项目端口
MIGRATE_PORT=3002  # 迁移项目端口
