...
// 启动脚本相关常量
const SCRIPT_DIRECTORY = '~/work/MyProject/code_mine/gitee/node_app/todolist'; // 脚本目录
...
async function updateFileDropdown() {
    try {
        ...
        const response = await fetch(buildApiUrl('/api/file/scan'));
...
async function checkServerStatus() {
    try {
        ...
        const fetchPromise = fetch(buildApiUrl('/api/status/check-status'), {
            method: 'GET',
            headers: {
...
async function performServerShutdown() {
    try {
        const response = await fetch(buildApiUrl('/api/status/shutdown'), {
            method: 'POST',
