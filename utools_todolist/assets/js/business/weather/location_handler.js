...
// 常量定义
const WEATHER_API = {
    AREA_CODES: buildApiUrl('/api/weather/weather-area-codes'),
    IP_LOCATION: buildApiUrl('/api/weather/ip-location'),
};
...
(function (window) {
    ...
    const LocationController = {
        ...
        onDistrictChange: function (isManual = false) {
            ...
            this._log(`选择的区县代码: ${selectedDistrictCode}`);

            // 调用全局天气加载函数
            loadWeatherData(selectedDistrictCode);
        },
